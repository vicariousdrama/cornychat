...
export function CustomEmojis({
  ...
  function resetEmojis() {
    let result = confirm(
      'Are you sure you want to reset the emoji list to defaults?'
    );
    if (result != true) {
      return;
    }
  ...
  let roomCustomEmojis = sessionStorage.getItem('customEmojis')
        ...
        {iOwn && (
          <div className="my-5">
            <p className="text-sm font-medium text-gray-300 p-2">
              Select the custom emoji reactions for this room. You can also
              include emojis that you've favorited at
              <a
              ...
              <div className="flex flex-wrap cursor-pointer">
                {customEmojis?.map((emoji, index) => {
                  ...
                  return (
                    ...
                    >
                      <p>
                        {emoji.toString().toUpperCase().startsWith('E') ? (
                          <img
                            src={`/img/emojis/emoji-${emoji
                              .toString()
                              .toUpperCase()}.png`}
                            style={{
                              width: '24px',
