        ...
        {textchats.map((textentry, index) => {
          ...
          return (
            ...
            >
              ...
              {isbold && isitalic && (
                <div className="flex-grow text-sm font-bold italic">
                  {thetext}
                </div>
              )}
              {isbold && !isitalic && (
                <div className="flex-grow text-sm font-bold">{thetext}</div>
              )}
              {!isbold && isitalic && (
                <div className="flex-grow text-sm italic">{thetext}</div>
              )}
              {!isbold && !isitalic && (
                <div className="flex-grow text-sm">{thetext}</div>
              )}
            </div>
          );
        })}
